...
<html lang="en-US">
  <head>
    ...
    <title>Commerce Solutions Indore</title>
	...
	<link href="img/title-icon-CS.jpg" rel="icon">
    ...
    <div class="cover-container">
      <div class="masthead clearfix">
        <div class="inner" style="margin-top: 30px;">
          <h3 class="masthead-brand">Commerce Solutions</h3>
          <nav class="nav nav-masthead">
            
            <a class="nav-link nav-social" href="https://www.youtube.com/channel/UCPI5qZGvXHnreMf4GQDZ2Jw" title="Youtube"><i class="fab fa-youtube" aria-hidden="true"></i></a>
			<a class="nav-link nav-social" href="https://www.facebook.com/commercesolutions/" title="Facebook"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
      ...
      <div class="inner cover">
        <h1 class="cover-heading">We have got a new address</h1>
        <p class="lead cover-copy">Visit us on <br> <span style="color:#edcf05">www.commercesolutions.in </span></p>
        <p class="lead"><a href="http://www.commercesolutions.in" class="btn btn-lg btn-default btn-notify">Visit Now</a></p>
      </div>
      <div class="mastfoot">
        <div class="inner">
